...
# Mendapatkan nilai min danmax dari kolom dteday
...
# Buat mapping untuk menjelaskan kategori musim
nama_musim = {
    1: 'Musim Semi',
    2: 'Musim Panas',
    3: 'Musim Gugur',
...
# Display the monthly rentals data in a table
...
st.markdown("""
            ...
            lebih sering terjadi pada waktu-waktu yang berbeda, terutama antara pertengahan tahun 2011 dan 2012. 
